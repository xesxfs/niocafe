...
class ScrollView extends eui.Scroller {
	...
	public init() {
		...
		//判断是垂直还是水平滚动
		var widthDist: number = this.viewport.contentWidth - this.stage.stageWidth;
		if (widthDist > 0) {
			this.isHScroller = true;
			this.itemSize = this.stage.stageWidth;
			this.itemNum = this.viewport.contentWidth / this.stage.stageWidth;
		} else {
